  ...
  return (
    <div className="min-h-screen flex flex-col justify justify-evenly items-center relative mb-0">
      ...
      <div className="flex flex-col justify justify-between items-center ">
        <div className="md:mt-[180px] xs:mt-5 text-6xl xs:text-sm text-center font-normal  tracking-wider md:leading-loose sm:leading-relaxed drop-shadow-2xl ">
          <div>Your</div> <div>Serene Path</div> <div>to</div>{" "}
          <div>Nature's</div>
          Beauty
        </div>
        <div className="flex flex-col justify justify-between items-center text-center relative mt-[160px] xs:mt-0 py-2 px-5 rounded-full  font-medium drop-shadow-2xl text-xl leading-loose">
