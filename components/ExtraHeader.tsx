  ...
  return (
    <section className="relative mt-0 sm:mt-24 lg:mt-40 pb-16 mb-16 grid gap-16 sm:gap-24 lg:gap-40 overflow-hidden">
      <div>
        ...
        <div className="flex flex-col justify-center items-center text-center relative mt-[200px] xs:mt-0 py-2 px-5 rounded-full text-yellow-10 font-medium drop-shadow-2xl text-lg leading-loose">
